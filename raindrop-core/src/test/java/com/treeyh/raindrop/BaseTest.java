...
public class BaseTest {
    ...
    public static RaindropDbConfig getDefaultRaindropDbConfig() {
        return RaindropDbConfig.builder().dbType(Consts.DB_TYPE_MYSQL)
                .dbUrl("jdbc:mysql://172.25.100.40:3306/raindrop_db?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useSSL=false&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=UTC")
                .dbPassword("mysqlpw")
